...
function init() {
...

    {
        ...
        //plane.position.set(planeGeometry.parameters.width/2 - rmx*squareRatio + cx, planeGeometry.parameters.height/2 - rmy*squareRatio + cy, 0);
        //plane.position.set(planeGeometry.parameters.width/2 - rmx*squareRatio + cx, planeGeometry.parameters.height/2 - rmy*squareRatio + cy, 0);
        plane.position.set(planeGeometry.parameters.width/2-rmx*squareRatio, -(planeGeometry.parameters.height/2-(planeGeometry.parameters.height - rmy*squareRatio)), 0)
        // add the plane to the scene
        scene.add(plane);
    }
