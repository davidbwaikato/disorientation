...
class Path extends Component {
    constructor(props) {
        ...
        Meteor.appstate.state = {
            pullRight: JSON.parse(Meteor.appstate("SDBR_pullRight")),
            touchHandleWidth: JSON.parse(Meteor.appstate("SDBR_touchHandleWidth")),
            checked1: JSON.parse(Meteor.appstate("SDBR_dockRight")),
            checked2: JSON.parse(Meteor.appstate("SDBR_dragEnabled")),
            ...
            //docked: JSON.parse(localStorage.)
        };
